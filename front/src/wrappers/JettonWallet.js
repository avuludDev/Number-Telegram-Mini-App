import { Address, beginCell, Cell, SendMode, Slice } from '@ton/core';
...
export class JettonWallet {
  ...
  async sendTransfer(
    ...
    const builder = beginCell()
      ...
      .storeAddress(Address.parse(opts.toAddress)) // jetton destination address. Use wallet address, not jetton address itself
